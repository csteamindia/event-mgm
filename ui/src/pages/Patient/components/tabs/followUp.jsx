...
const PatientFollowUp = ({ isFormPreOpen = false, patientData }) => {
    ...
    const [formsData, setFormsData] = useState({ followup_date: '', remark: '', note: '', added_by: '1' })
                                ...
                                <Col >
                                    <div className="form-group mb-4">
                                        ...
                                        <Flatpickr
                                            ...
                                            value={formsData.followup_date}
                                            onChange={(date) => {
                                                setFormsData(prev => ({
                                                    ...prev,
                                                    followup_date: date[0]?.toISOString() || ''
                                                }));
                                            }}
                                        />
                                    </div>
    ...
    return (
        <Datatables
            isSearch={true}
            columns={ManagePatientFollowUpColumns()}
            showTableOnly={true}
